...
class PlayerInstance {
    ...
    public void a(EntityPlayer entityplayer) {
        if (this.b.contains(entityplayer)) {
            ...
            entityplayer.netServerHandler.sendPacket(new Packet50PreChunk(this.e.a, this.e.b, true));
    ...
    public void b(EntityPlayer entityplayer) {
        if (!this.b.contains(entityplayer)) {
            ...
            if (entityplayer.ai.contains(this.e)) {
                entityplayer.netServerHandler.sendPacket(new Packet50PreChunk(this.c, this.d, false));
            }
        }
    }
