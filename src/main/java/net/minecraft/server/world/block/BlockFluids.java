...
public abstract class BlockFluids extends Block {
    ...
    private Vec3D ce(IBlockAccess iblockaccess, int i, int j, int k) {
    ...
    public void a(World world, int i, int j, int k, Entity entity, Vec3D vec3d) {
        Vec3D vec3d1 = this.ce(world, i, j, k);
        ...
        if (world.a(i, j, k) == this.bi) {
            if (this.bt == Material.g) {
                ...
                if (flag) {
                    ...
                    if (l == 0) {
                        world.d(i, j, k, Block.OBSIDIAN.bi);
                    } else if (l <= 4) {
                        world.d(i, j, k, Block.COBBLESTONE.bi);
                    }
