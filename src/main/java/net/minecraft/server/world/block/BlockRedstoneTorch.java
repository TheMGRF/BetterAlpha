...
public class BlockRedstoneTorch extends BlockTorch {
    ...
    private boolean a(World world, int i, int j, int k, boolean flag) {
        if (flag) {
            b.add(new RedstoneUpdateInfo(i, j, k, world.lastUpdate));
        }
    ...
    public void a(World world, int i, int j, int k, Random random) {
        ...
        while (b.size() > 0 && world.lastUpdate - ((RedstoneUpdateInfo) b.get(0)).d > 100L) {
            b.remove(0);
        }

        if (this.a) {
            if (flag) {
                world.b(i, j, k, REDSTONE_TORCH_OFF.bi, world.b(i, j, k));
            ...
            world.b(i, j, k, REDSTONE_TORCH_ON.bi, world.b(i, j, k));
        }
    }
