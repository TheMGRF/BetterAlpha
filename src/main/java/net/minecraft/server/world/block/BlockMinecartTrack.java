...
import net.minecraft.server.utils.MinecartTrackLogic;
...
public class BlockMinecartTrack extends net.minecraft.server.world.block.Block {
    ...
    public void b(World world, int i, int j, int k, int l) {
        if (!world.z) {
            ...
            if (flag) {
                ...
                world.d(i, j, k, 0);
            } else if (l > 0 && net.minecraft.server.world.block.Block.n[l].c() && MinecartTrackLogic.a(new MinecartTrackLogic(this, world, i, j, k)) == 3) {
                this.g(world, i, j, k);
            }
        }
    }
