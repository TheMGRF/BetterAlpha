...
public class BlockFire extends Block {
    ...
    public void a(World world, int i, int j, int k, Random random) {
        ...
        } else if (!flag && !this.be(world, i, j - 1, k) && l == 15 && random.nextInt(4) == 0) {
            world.d(i, j, k, 0);
        } else {
            if (l % 2 == 0 && l > 2) {
    ...
    private boolean g(World world, int i, int j, int k) {
        return this.be(world, i + 1, j, k) ? true : (this.be(world, i - 1, j, k) ? true : (this.be(world, i, j - 1, k) ? true : (this.be(world, i, j + 1, k) ? true : (this.be(world, i, j, k - 1) ? true : this.be(world, i, j, k + 1)))));
    }
    ...
    public boolean be(IBlockAccess iblockaccess, int i, int j, int k) {
    ...
    public void e(World world, int i, int j, int k) {
        if (world.a(i, j - 1, k) != Block.OBSIDIAN.bi || !Block.PORTAL.a_(world, i, j, k)) {
            if (!world.d(i, j - 1, k) && !this.g(world, i, j, k)) {
                world.d(i, j, k, 0);
            } else {
                world.h(i, j, k, this.bi);
