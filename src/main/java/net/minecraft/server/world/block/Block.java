...
public class Block {
    ...
    public static final BlockFire FIRE = (BlockFire) (new BlockFire(51, 31)).c(0.0F).a(1.0F).a(f);
    ...
    public static final BlockPortal PORTAL = (BlockPortal) (new BlockPortal(90, 14)).c(-1.0F).a(k).a(0.75F);
    ...
    public boolean a(IBlockAccess iblockaccess, int i, int j, int k, int l) {
        return l == 0 && this.bm > 0.0D || (l == 1 && this.bp < 1.0D || (l == 2 && this.bn > 0.0D || (l == 3 && this.bq < 1.0D || (l == 4 && this.bl > 0.0D || (l == 5 && this.bo < 1.0D || !iblockaccess.d(i, j, k))))));
    }
    ...
    public MovingObjectPosition a(World world, int i, int j, int k, Vec3D vec3d, Vec3D vec3d1) {
        ...
        if (vec3d8 == null) {
            ...
            return new MovingObjectPosition(i, j, k, b0, vec3d8.c(i, j, k));
        }
    }

    private boolean a(Vec3D vec3d) {
        return vec3d != null && vec3d.b >= this.bm && vec3d.b <= this.bp && vec3d.c >= this.bn && vec3d.c <= this.bq;
    }

    private boolean b(Vec3D vec3d) {
        return vec3d != null && vec3d.a >= this.bl && vec3d.a <= this.bo && vec3d.c >= this.bn && vec3d.c <= this.bq;
    }

    private boolean c(Vec3D vec3d) {
        return vec3d != null && vec3d.a >= this.bl && vec3d.a <= this.bo && vec3d.b >= this.bm && vec3d.b <= this.bp;
    }
